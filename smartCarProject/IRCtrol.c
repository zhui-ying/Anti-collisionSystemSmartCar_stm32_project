   ...
   { 
     return; }
		 ...
		 switch(IRCOM[2])
		 {
			 ...
			 case 0x0c: ctrl_comm = COMM_S_ADD;break;
			 case 0x08: ctrl_comm = COMM_S_SUB;break;
			 case 0x18: ctrl_comm = COMM_K_ADD;break;
			 case 0x1c: ctrl_comm = COMM_K_SUB;break;
			 case 0x5e: ctrl_comm = COMM_B_ADD;break;
			 case 0x5a: ctrl_comm = COMM_B_SUB;break;
			 default :  return;
		 }
		 ir_rec_flag = 1;
