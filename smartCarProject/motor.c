...
void CarGo(void)
{
	front_left_speed_duty=speedduty;
	front_right_speed_duty=speedduty;
	behind_left_speed_duty=speedduty;
	behind_right_speed_duty=speedduty;
}
...
void CarLeft(void)
{
	...
	behind_right_speed_duty=speedduty+10;//增加后轮驱动力
}
...
void CarRight(void)
{
	...
	behind_left_speed_duty=speedduty+10;//增加后轮驱动力
